 ...
 */
final class Version20240108093158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE navire CHANGE nom nom VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE navire CHANGE nom nom VARCHAR(3) NOT NULL');
    }
}
